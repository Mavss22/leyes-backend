...
const allowAll = originsList.includes('*'); // ⭐ soporte para "*"
...
// Empresas (público con token si tu middleware interno valida)
...
// ---------- Archivos subidos ----------
// Nota: En Railway el filesystem es efímero. Úsalo solo para pruebas.
// Para producción real considera S3/Cloud Storage.
